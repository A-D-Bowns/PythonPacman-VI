...
blinky_img = pygame.transform.scale(pygame.image.load(f'assets/ghost_images/pink.png'), (45, 45))
pinky_img = pygame.transform.scale(pygame.image.load(f'assets/ghost_images/blue.png'), (45, 45))
...
def draw_misc():
    ...
    if game_over:
        ...
        gameover_text = font.render('YOU HAVE BEEN INFECTED. Space bar to restart!', True, 'red')
        screen.blit(gameover_text, (100, 300))
    if game_won:
        pygame.draw.rect(screen, 'white', [50, 200, 800, 300],0, 10)
        pygame.draw.rect(screen, 'dark gray', [70, 220, 760, 260], 0, 10)
        gameover_text = font.render('CONGRATULATIONS, YOU BEAT ALL OF THE VIRAL INFECTION! Space bar to restart!', True, 'green')
        screen.blit(gameover_text, (100, 300))
